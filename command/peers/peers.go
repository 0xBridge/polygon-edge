...
import (
	...
	"github.com/0xBridge/polygon-edge/command/peers/add"
	"github.com/0xBridge/polygon-edge/command/peers/list"
	"github.com/0xBridge/polygon-edge/command/peers/status"
