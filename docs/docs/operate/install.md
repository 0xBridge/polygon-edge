...
To access the pre-built releases, visit the [<ins>GitHub releases page</ins>](https://github.com/0xBridge/polygon-edge/releases). 
The client provides cross-compiled AMD64/ARM64 binaries for Darwin and Linux.

!!! info "Latest release: 1.3.0"

    **The latest stable test release is [<ins>v1.3.0</ins>](https://github.com/0xBridge/polygon-edge/releases/tag/v1.3.0).**
...
Use the following commands to clone the Polygon Edge repository and build from source:
  ...
  ```bash
  git clone https://github.com/0xBridge/polygon-edge.git
  cd polygon-edge/
